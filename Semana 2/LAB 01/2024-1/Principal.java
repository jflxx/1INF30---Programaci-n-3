...
class Principal{ 
    /* Coloque sus datos 
    Nombre Completo: Alfredo Jimenez Felix
    Código PUCP: 20221736
    */ 
    public static void main(String[] args) throws Exception{ 
        ...
        AtencionMedica atm01 = new ConsultaPresencial(pac01, med01, sdf.parse("29-03-2024 16:00"),
        	"DOLOR DE ESPALDA", con01, false);
        //Creamos una atencion medica de tipo Examen Diagnostico para el 30 de Marzo a las 08:30 
        AtencionMedica atm02 = new ExamenDiagnostico(pac01, med02, sdf.parse("30-03-2024 08:30"),
        	sal01, TipoExamen.ECOGRAFIA);

        //Creamos una atencion medica de tipo Teleconsulta para el 01 de Abril a las 15:30 
        AtencionMedica atm03 = new Teleconsulta(pac01, med03, sdf.parse("01-04-2024 15:30"),
        	"DOLOR DE GARGANTA", Plataforma.ZOOM, "https://pucp.zoom.us/j/98403730464");
